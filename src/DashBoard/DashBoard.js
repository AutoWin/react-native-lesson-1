...
export default class DashBoard extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      data: [
        {id:1, title: "Project List", image:"https://img.icons8.com/color/70/000000/cottage.png"},
        {id:1, title: "Member", image:"https://img.icons8.com/color/70/000000/administrator-male.png"},
