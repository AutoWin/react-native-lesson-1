...
let buttons = ['Check I/O', 'Plan', 'Tasks']
  ...
  renderItem = ({ item }) => {
    return (
      <View>
        ...
        {/* <Button
          onPress={() => { this.onPress_btnCheckInCheckOut(item) }}>
          <AntDesign name="logout"/><Text>&nbsp;Check I/O</Text>
        </Button> */}
      ...
      <ButtonGroup title="Check I/O"
      />
      <ButtonGroup title="Plan"
      />
      <ButtonGroup title="Tasks"
      />
      </View>
